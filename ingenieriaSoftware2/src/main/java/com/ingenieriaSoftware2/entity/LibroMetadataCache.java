...
@Entity @Table(name="libro_metadata_cache")
@Getter @Setter @NoArgsConstructor @AllArgsConstructor
public class LibroMetadataCache {
    @Id @Column(name="isbn", nullable=false) private String isbn;
    @Column(name="google_books_id", unique=true) private String googleBooksId;
    @Column(name="titulo", nullable=false) private String titulo;
    @Column(name="autores") private String autores;
    @Column(name="puntuacion_externa", precision=19, scale=2) private BigDecimal puntuacionExterna;
